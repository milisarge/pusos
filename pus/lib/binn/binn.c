...
BINN_PRIVATE BOOL is_bool_str(char *str, BOOL *pbool) {
  ...
  if (strcmp(str, "true") == 0) goto loc_true;
  if (strcmp(str, "yes") == 0) goto loc_true;
  if (strcmp(str, "on") == 0) goto loc_true;
  //if (stricmp(str, "1") == 0) goto loc_true;

  if (strcmp(str, "false") == 0) goto loc_false;
  if (strcmp(str, "no") == 0) goto loc_false;
  if (strcmp(str, "off") == 0) goto loc_false;
